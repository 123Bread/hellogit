...
public class MemcachedUtils {  
    ...
    private static final String prefixKey = "QsClient";
    
    static {  
        if (cachedClient == null)  
            cachedClient = new MemCachedClient("QsClientMemcache");  
    }  
    ...
    private static boolean setExp(String key, Object value, Date expire) {  
        boolean flag = false;  
        try {  
            flag = cachedClient.set(prefixKey + key, value, expire);  
        } catch (Exception e) {  
    ...
    private static boolean addExp(String key, Object value, Date expire) {  
        boolean flag = false;  
        try {  
            flag = cachedClient.add(prefixKey + key, value, expire);  
        } catch (Exception e) {  
            // 记录Memcached日志  
    ...
    private static boolean replaceExp(String key, Object value, Date expire) {  
        boolean flag = false;  
        try {  
            flag = cachedClient.replace(prefixKey + key, value, expire);  
        } catch (Exception e) {  
    ...
    public static Object get(String key) {  
        Object obj = null;  
        try {  
            obj = cachedClient.get(prefixKey + key);  
        } catch (Exception e) {  
    ...
    public static boolean delete(String key) {  
        boolean flag = false;  
        try {  
            flag = cachedClient.delete(prefixKey + key);  
        } catch (Exception e) {  
    ...
    public static boolean keyExists(String key) {  
        boolean flag = false;  
        try {  
            flag = cachedClient.keyExists(prefixKey + key);  
        } catch (Exception e) { 
        	logger.error("Memcached keyExists方法报错，key值： {}", key, e);
            //MemcachedLog.writeLog("Memcached flashAll方法报错\r\n" + exceptionWrite(e));  
        }  
        return flag;   
    }  
    ...
    private static class MemcachedLog {  
        ...
        *//** 
        ...
        public static void writeLog(String content) {  
            try {  
                logWrite.write("[" + PID + "] " + "- [" + DateUtils.format(new Date(),DateUtils.TIMESTAMP_PATTERN) + "]\r\n"  
                        + content);  
                logWrite.newLine();  
                logWrite.flush();  
            } catch (IOException e) {  
